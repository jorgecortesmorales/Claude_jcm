---
title: "Capítulo VII. Inserción de México en las cadenas de valor globales"
chapter: "VII"
lang: es-ES
---
...
# Capítulo VII. Inserción de México en las cadenas de valor globales

## VII.1 Propósito y enfoque
...
## VII.3 El desplazamiento de los destinos hacia Asia

La segunda cara del comercio es su geografía. El destino de las exportaciones en bruto se ha desplazado a lo largo de la serie desde Norteamérica y Europa hacia Asia, y en particular China, cuya participación en las exportaciones del bloque pasó de ser prácticamente nula antes de 2004 al 7 % en 2008, el 16 % en 2016 y el 35 % en 2024 (Ilustración {{fig:china}}). El giro es más agudo en los concentrados de fase 1: el cobre en concentrado, que en 1995 se destinaba casi en su totalidad a Estados Unidos, en años recientes se dirige mayoritariamente a China; los concentrados de plomo, zinc y oro se orientan a Corea del Sur y China. En contraste, los productos con algún grado de transformación mantienen su mercado tradicional —el ácido fluorhídrico se exporta a Estados Unidos en toda la serie—.
...
La comparación gana precisión al calcular el encadenamiento no solo para la extracción, sino también para la refinación (industrias metálicas básicas) y la semimanufactura (productos metálicos) de cada país (Ilustración {{fig:eslintl}}). El contraste es nítido: **China** sostiene el arrastre de la extracción a la refinación (1.53 → 1.30): es el procesador integrado. **México** cae más (1.51 → 1.17): su alto arrastre extractivo no se prolonga con la misma fuerza a la transformación. En el otro extremo, **Chile** —con una extracción de arrastre bajísimo (0.73)— tiene la refinación más integrada (1.23): su poca fundición sí alimenta industria, lo que confirma que el índice extractivo aislado engaña en ambos sentidos. Este patrón coincide con el observado por mineral en el Capítulo VI (la refinación de metales preciosos cae a 0.62) y por entidad, donde la transformación metálica con más arrastre se concentra en el eje siderúrgico del noreste.
...
| Mineral | Producto estratégico | ¿México lo produce? |
|---|---|---|
| Grafito | Grafito natural grado batería (ánodos) | No |
| Sílice | Silicio metálico; cuarzo de alta pureza | No (importa) |
| Manganeso | Sulfato de manganeso grado batería | No (importa) |
| Fluorita | Ácido fluorhídrico → fluoropolímeros (PTFE) | HF sí; fluoropolímeros no (importa) |
